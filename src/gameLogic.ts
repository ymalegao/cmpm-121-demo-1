    ...
    this.availableItems = [
      {
        ...
        cost: 10,
        rate: 0.1,
        description: "Serfs enjoy protection without land.",
      },
      {
        name: "Knights of the Square Table",
        cost: 100,
        rate: 2,
        description: "Not as good as the Roundtable.",
      },
      {
        name: "Plebeian",
        cost: 500,
        rate: 5,
        description: "One Roman is worth 50 serfs.",
      },
      {
        name: "Singing Bard",
        cost: 1000,
        rate: 50,
        description: "Will sing for crowns.",
      },
      {
        name: "Playful Jester",
        cost: 2000,
        rate: 100,
        description: "They get to make fun of royalty.",
      },
    ];
  }
